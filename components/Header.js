    ...
    <div className="shadow-sm border-b bg-white sticky top-0 z-50">
      <div className="flex justify-between max-w-6xl mx-5 xl:mx-auto">
        ...
        <div className="flex items-center justify-end space-x-4">
          <HomeIcon
            onClick={() => router.push('/')}
            className="navBtn md:inline-flex hover:scale-125"
          />
          <MenuIcon className="h-6 md:hidden cursor-pointer" />

          {session ? (
            <>
              <div className="relative navBtn md:inline-flex hover:scale-125">
                <PaperAirplaneIcon
                  className="navBtn md:inline-flex hover:scale-125
          rotate-45"
                />
          ...
          flex items-center justify-center animate-pulse text-white"
              ...
              <PlusCircleIcon
                ...
                className="navBtn md:inline-flex hover:scale-125"
              />
              <UserGroupIcon className="navBtn md:inline-flex hover:scale-125" />
              <HeartIcon className="navBtn md:inline-flex hover:scale-125" />
